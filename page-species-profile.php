...
<link href="<?php echo get_template_directory_uri(); ?>/VAL_Species_Page/css/species-page-styles.css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>/VAL_Species_Page/css/species-map-styles.css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>/VAL_Web_Utilities/css/pheno.css" rel="stylesheet">
...
<script src="<?php echo get_template_directory_uri(); ?>/VAL_Web_Utilities/js/moment.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/VAL_Web_Utilities/js/purify.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/VAL_Species_Page/js/valSpeciesPage.js" type="module"></script>
